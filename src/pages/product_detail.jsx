        ...
        <>
            <section className="mx-auto max-w-screen-xl p-4">
                ...
                <div className="py-4 grid grid-cols-2">
                    ...
                    <div>
                        <h1 className="font-bold text-xl">Elfbar T600 Mango 20mg</h1>
                        <h6><span>Artikelnummer: </span> VB1010-04</h6>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta quibusdam unde aperiam commodi! Beatae neque a dolorum voluptatem accusamus. Eveniet sunt harum nobis facilis expedita repudiandae ut in dolor doloribus!</p>

                        <h4>Rp. 200.000</h4>
                        <h4 className="font-semibold mb-2">Flavor</h4>
                        <div className="flex gap-2">
                            {product.variants.flavor.map(item => (
                                <button key={item.id} onClick={() => setSelectFlavor(item)}
                                    className={`px-3 py-1 rounded-full border text-sm transition ${selectedFlavor?.id === item.id ? "border-blue-600 bg-blue-50" : "border-gray-300"}`}
                                >
                                    {item.label}
                                </button>
                            ))}

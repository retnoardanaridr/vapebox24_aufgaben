                ...
                <div className="mx-auto w-full max-w-screen-xl">
                    <div className="grid grid-cols-1 gap-8 px-4 py-6 lg:py-8 md:grid-cols-2">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3">
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-heading uppercase underline">Kategorien</h2>
                                <ul className="text-body font-medium">
                                    <li className="mb-4">
                                        <Link to="" className="hover:underline">Aktionen</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline">E-Liquids</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to="" className="hover:underline">Vapes</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Big Puff</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Snacks</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Drinks</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Tabak</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Trendartikel</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link href="#" className="hover:underline">Promotion/Display</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-heading uppercase underline">Informationen</h2>
                                <ul className="text-body font-medium">
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline">Zahlungsmöglichkeiten</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline">Versandinformationen</Link>
                                    </li>
                                    <li className="mb-4">
                                        <Link to="#" className="hover:underline">Karriere</Link>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-heading uppercase underline">Gesetzliche Informationen</h2>
                                <ul className="text-body font-medium">
                                    <li className="mb-4">
